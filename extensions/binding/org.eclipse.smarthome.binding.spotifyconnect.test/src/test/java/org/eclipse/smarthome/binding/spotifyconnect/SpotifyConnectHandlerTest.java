...
/**
 * Tests cases for {@link SpotifyConnectHandler}. The tests provide mocks for supporting entities using Mockito.
 *
 * @author Andreas Stenlund - Initial contribution
 */
public class SpotifyConnectHandlerTest {
    ...
    public void setUp() {
        initMocks(this);
        handler = new SpotifyConnectHandler((Bridge) thing);
